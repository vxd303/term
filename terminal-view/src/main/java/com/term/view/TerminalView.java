...
import com.term.view.textselection.TextSelectionCursorController;
...
public final class TerminalView extends View {
     ...
     * {@link com.term.terminal.TerminalSessionClient#onTerminalCursorStateChange(boolean)}
    ...
    protected void onDetachedFromWindow() {
        ...
        if (mTextSelectionCursorController != null) {
            ...
            // android.view.WindowLeaked: Activity com.term.app.TermuxActivity has leaked window android.widget.PopupWindow
            stopTextSelectionMode();
