package com.term.shared.activities;
...
import com.term.shared.file.filesystem.FileType;
 ...
 * {@code `<activity android:name="com.term.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.TermuxReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="com.term.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
