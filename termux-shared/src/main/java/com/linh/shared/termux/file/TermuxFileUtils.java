package com.linh.shared.termux.file;

import static com.linh.shared.termux.TermuxConstants.TERMUX_PREFIX_DIR_PATH;
...
import com.linh.shared.file.FileUtilsErrno;
...
public class TermuxFileUtils {
     ...
     *
     *
     * Also note that running `/system/bin/ls -lhd /data/user/0/com.linh` as secondary user will result
     * in `ls: /data/user/0/com.linh: Permission denied` where `0` is primary user id but running
     * `/system/bin/ls -lhd /data/user/10/com.linh` will result in
     * `drwx------ 6 u10_a149 u10_a149 4.0K 2021-xx-xx xx:xx /data/user/10/com.linh` where `10` is
