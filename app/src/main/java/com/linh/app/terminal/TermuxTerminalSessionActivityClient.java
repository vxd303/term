...
import com.linh.shared.termux.terminal.io.BellHandler;
import com.linh.shared.logger.Logger;
import com.linh.terminal.TerminalColors;
import com.linh.terminal.TerminalSession;
import com.linh.terminal.TerminalSessionClient;
import com.linh.terminal.TextStyle;
    ...
    private synchronized void loadBellSoundPool() {
        if (mBellSoundPool == null) {
            ...
            try {
                ...
                // Catch java.lang.RuntimeException: Unable to resume activity {com.linh/com.linh.app.TermuxActivity}: android.content.res.Resources$NotFoundException: File res/raw/bell.ogg from drawable resource ID
