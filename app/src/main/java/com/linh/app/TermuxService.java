...
import com.linh.R;
import com.linh.app.event.SystemEventReceiver;
import com.linh.app.terminal.TermuxTerminalSessionActivityClient;
import com.linh.app.terminal.TermuxTerminalSessionServiceClient;
import com.linh.shared.termux.plugins.TermuxPluginUtils;
import com.linh.shared.data.IntentUtils;
import com.linh.shared.net.uri.UriUtils;
import com.linh.shared.errors.Errno;
import com.linh.shared.shell.ShellUtils;
import com.linh.shared.shell.command.runner.app.AppShell;
import com.linh.shared.termux.settings.properties.TermuxAppSharedProperties;
import com.linh.shared.termux.shell.command.environment.TermuxShellEnvironment;
import com.linh.shared.termux.shell.TermuxShellUtils;
import com.linh.shared.termux.TermuxConstants;
import com.linh.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_ACTIVITY;
import com.linh.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_SERVICE;
import com.linh.shared.termux.settings.preferences.TermuxAppSharedPreferences;
import com.linh.shared.termux.shell.TermuxShellManager;
...
import com.linh.shared.notification.NotificationUtils;
...
import com.linh.shared.shell.command.ExecutionCommand.ShellCreateMode;
import com.linh.terminal.TerminalEmulator;
    ...
    private synchronized void killAllTermuxExecutionCommands() {
        ...
        for (int i = 0; i < pendingPluginExecutionCommands.size(); i++) {
            ...
            if (!executionCommand.shouldNotProcessResults() && executionCommand.isPluginExecutionCommandWithPendingResult()) {
                if (executionCommand.setStateFailed(Errno.ERRNO_CANCELLED.getCode(), this.getString(com.linh.shared.R.string.error_execution_cancelled))) {
