...
import com.term.R;
import com.term.app.event.SystemEventReceiver;
import com.term.app.terminal.TermuxTerminalSessionActivityClient;
import com.term.app.terminal.TermuxTerminalSessionServiceClient;
import com.term.shared.termux.plugins.TermuxPluginUtils;
import com.term.shared.data.IntentUtils;
import com.term.shared.net.uri.UriUtils;
import com.term.shared.errors.Errno;
import com.term.shared.shell.ShellUtils;
import com.term.shared.shell.command.runner.app.AppShell;
import com.term.shared.termux.settings.properties.TermuxAppSharedProperties;
import com.term.shared.termux.shell.command.environment.TermuxShellEnvironment;
import com.term.shared.termux.shell.TermuxShellUtils;
import com.term.shared.termux.TermuxConstants;
import com.term.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_ACTIVITY;
import com.term.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_SERVICE;
import com.term.shared.termux.settings.preferences.TermuxAppSharedPreferences;
import com.term.shared.termux.shell.TermuxShellManager;
...
import com.term.shared.notification.NotificationUtils;
...
import com.term.shared.shell.command.ExecutionCommand.ShellCreateMode;
    ...
    private synchronized void killAllTermuxExecutionCommands() {
        ...
        for (int i = 0; i < pendingPluginExecutionCommands.size(); i++) {
            ...
            if (!executionCommand.shouldNotProcessResults() && executionCommand.isPluginExecutionCommandWithPendingResult()) {
                if (executionCommand.setStateFailed(Errno.ERRNO_CANCELLED.getCode(), this.getString(com.term.shared.R.string.error_execution_cancelled))) {
